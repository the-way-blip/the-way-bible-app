          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              {copied ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-warm-brown-light">
            ...
            <button
              ...
              className="flex flex-col items-center gap-1.5 py-3 bg-cream rounded-xl hover:bg-cream-dark transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-warm-brown-light">
