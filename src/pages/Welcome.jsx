    ...
    <header className="sticky top-0 z-40 bg-cream/95 backdrop-blur border-b border-cream-dark">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-2 sm:gap-4">
          ...
          <Link to="/login" className="text-sm text-warm-brown-light hover:text-warm-brown px-2">Sign in</Link>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:py-32 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              href="#signup"
              className="bg-gold text-white font-semibold px-6 py-3 rounded-full hover:bg-gold/90 transition-colors shadow-lg shadow-gold/20"
            >
              Get Started Free
            </a>
            <span className="inline-flex items-center gap-2 text-warm-brown-light text-sm font-medium border border-cream-dark px-5 py-3 rounded-full bg-white/60">
